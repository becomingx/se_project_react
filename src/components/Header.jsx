        ...
        <header className="header">
            ...
            <div className="header__right">
              <div className="header__user">
                ...
                <img src={avatar} alt={`${userName}'s avatar`} className="header__avatar"/>
              </div>
            </div>
            ...
            <div className="header__top-row">
              ...
              <div className="header__info_mobile">
                {!menu && 
                  (
                    <img className="header__logo_mobile" src={logo} alt="WTWR logo"></img>
                  )
                }

                <div className={menu ? "mobile__menu_opened" : "mobile__menu"} onClick={handleMobileMenu}>
                  {!menu && 
                    (
                      <div className="mobile__menu_lines-container">
                        <div className="mobile__menu_line"></div>
                        <div className="mobile__menu_line"></div>
                      </div>
                    )
                  }
                    ...
                    (
                      <div className="mobile__menu_content">
                        ...
                        <div className="mobile__menu_top-row">
                          ...
                          <img src={avatar} alt={`${userName}'s avatar`} className="header__avatar_mobile"/>
                        </div>
            ...
            <div className="header__bottom-row">
              <div className="header__date-location_mobile">
                {!menu && (<div className="header__date-location_mobile-content">
                  <p className="header__date">{headerDate}</p>
                  <p className="header__location">{weatherData.city}</p>
                </div>)}
              </div>
